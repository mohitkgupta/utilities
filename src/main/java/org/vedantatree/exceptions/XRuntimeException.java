...
public class XRuntimeException extends RuntimeException
{
	...
	protected static final Log		LOGGER					= LogFactory.getLog( XRuntimeException.class );
	...
	public XRuntimeException( String message, int pErrorCode )
	{
		this( message, pErrorCode, null, false, false );
	}

	public XRuntimeException( String message, int errorCode, boolean debug, boolean sendMail )
	{
		this( message, errorCode, null, debug, sendMail );
	}

	public XRuntimeException( String message, int errorCode, Throwable cause )
	{
		this( message, errorCode, cause, false, false );
	}

	public XRuntimeException( String message, int errorCode, Throwable cause, boolean debug, boolean sendMail )
	{
		super( message, null );
	 ...
	 * The string loaded from resource bunder using error code should be
